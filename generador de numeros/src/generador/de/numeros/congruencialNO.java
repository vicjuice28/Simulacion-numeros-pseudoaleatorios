 ...
 * @author victo
 */
public class congruencialNO extends javax.swing.JFrame {

    /**
     * Creates new form cuadradosmedios
     */
    public congruencialNO() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Congruencial no lineal cuadratico");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(aTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(31, 31, 31)
                        .addComponent(generarBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel6)
                            .addComponent(generarBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
    ...
    private void generarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generarBtnActionPerformed
        ...
        int semilla=0,mod=0,valora=0,valorb=0,valorc=0;
        int numcuadrado,numero2;
        
        try{
            semilla = Integer.parseInt(semillaTxt.getText());
            valora = Integer.parseInt(aTxt.getText());
            valorb = Integer.parseInt(bTxt.getText());
            valorc = Integer.parseInt(cTxt.getText());
        ...
        for(int i=0;i<500;i++){
                ...
                numcuadrado = semilla * semilla;
                numero2 = ((valora*numcuadrado)+(valorb*semilla)+valorc) % mod;                
                semilla = numero2;
                media.add((float)(semilla));
                
                TextArea.append("Semilla: "+semilla +"\n");
  ...
  */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(congruencialNO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
