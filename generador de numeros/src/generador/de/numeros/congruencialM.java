 ...
 * @author victo
 */
public class congruencialM extends javax.swing.JFrame {

    /**
     * Creates new form cuadradosmedios
     */
    public congruencialM() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(constantTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26)
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(modTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void generarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generarBtnActionPerformed
        ...
        double semilla = 0, constante=0,valorC=0,mod=0;
        ...
        if(semillaTxt.getText().length()<4){
            ...
            for(int i=0;i<500;i++){
                ...
                numero1 = (constante*semilla)% mod;
                numero2 = numero1 / (mod-1);
                media.add((float)(numero2));
                TextArea.append("Semilla: "+semilla +"\t"+"R"+i+": "+ format.format(numero2) +"\n");
                semilla = numero1;
  ...
  */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(congruencialM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
